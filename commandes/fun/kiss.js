...
.setTitle(`:kissing_heart: **${message.author.username}** give a kiss to **${user.user.username}**`)
.setImage(randomkiss)
.setColor(db.color)
.setFooter(`kodb`)
...
var embed = new MessageEmbed()
.setTitle(`:kissing_heart: **${message.author.username}** give a kiss to **${member.user.username}**`)
.setImage(randomkiss)
.setColor(db.color)
.setFooter(`kodb`)
message.channel.send(embed)
...
var embed = new MessageEmbed()
.setTitle(`:kissing_heart: **${message.author.username}** give a kiss to **${client.user.username}**`)
.setImage(randomkiss)
.setFooter(`kodb`)
.setColor(db.color)
message.channel.send(embed)
