...
if(!str_chan) return;
str_chan.send({embed:{ description: `**${member.user.username}**#${member.user.discriminator} (\`${member.user.id}\`) have joined the guild!\n`, color: 3553599, author: { name: "🙌 New members" }, footer: { text: `🕙 ${getNow().time}` } }}) 
} 
